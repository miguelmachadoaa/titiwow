    ...
    public function categorias($slug)
    {
      ...
      $cart= \Session::get('cart');
       ...
       ->whereNull('alp_productos.deleted_at')
        ...
        $destacados =  DB::table('alp_productos')->select('alp_productos.*', 'alp_marcas.order as order','alp_marcas.order as order', 'alp_marcas.nombre_marca as nombre_marca', 
    ...
    public function marcas($slug)
    {
      ...
      $cart= \Session::get('cart');
       ...
       if (isset($cart['id_forma_pago']) || isset($cart['id_forma_envio']) || isset($cart['id_cliente']) || isset($cart['id_almacen']) || isset($cart['id_direccion']) || isset($cart['inventario']) ) {
        ...
        $productos =  DB::table('alp_productos')->select('alp_productos.*', 'alp_marcas.order as order','alp_marcas.order as order', 'alp_marcas.nombre_marca as nombre_marca', 
        'alp_categorias.nombre_categoria as nombre_categoria')
        ->join('alp_marcas','alp_productos.id_marca' , '=', 'alp_marcas.id')
        ->join('alp_categorias','alp_productos.id_categoria_default' , '=', 'alp_categorias.id')
   ...
   # dd($prods);
    ...
    private function combos()
    {
      ...
      foreach ($c as $co) {
        ...
        $lista=AlpCombosProductos::select('alp_combos_productos.*', 'alp_productos.slug as slug', 'alp_productos.nombre_producto as nombre_producto', 'alp_productos.imagen_producto as imagen_producto', 'alp_productos.estado_registro as estado_producto','alp_marcas.nombre_marca', 'alp_categorias.nombre_categoria')
