...
class VerificarPagosPrueba extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'verificar:pagosprueba';
    ...
    public function handle()
    {
      ...
      $d=$date->subDay(3)->format('Y-m-d');
       ...
       # dd($ordenes);
        ...
        $ordenes=AlpOrdenes::where('id', '31665')->get();
           ...
           if ( $aproved ) 
             {
              ...
              if ($orden->id_almacen==1 || $orden->id_almacen==32) {
                ...
                try {
                  ...
                  #$this->registrarOrden($orden->id);
                  #$this->registrarOrdenNuevo($orden->id);
                ###  $this->AprobarOrdenCompramas($orden->id);
...
private function AprobarOrdenCompramas($id_orden)
{
  ...
  $detalles = AlpDetalles::select('alp_ordenes_detalle.*','alp_productos.nombre_producto as nombre_producto','alp_productos.imagen_producto as imagen_producto','alp_productos.referencia_producto as referencia_producto','alp_productos.cantidad as cantidad_producto')
    ...
    $url= 'https://ff.startupexpansion.co/api/v1/webhooks/alpinago/'.$orden->referencia.'/approve';
...
private function CancelarOrdenCompramas($id_orden)
{
  ...
  $detalles = AlpDetalles::select('alp_ordenes_detalle.*','alp_productos.nombre_producto as nombre_producto','alp_productos.imagen_producto as imagen_producto','alp_productos.referencia_producto as referencia_producto','alp_productos.cantidad as cantidad_producto')
    ...
    #https://ff.startupexpansion.co/api/v1/webhooks/alpinago/:id/cancel
