...
class AdminSeeder extends DatabaseSeeder {
	...
	public function run()
	{
		...
		$sacRole = Sentinel::getRoleRepository()->createModel()->create([
			...
			'slug' => 'sac',
			'tipo' => 1,
			'permissions' => array('ordenes.index'=>true,'ordenes.create'=>true,'ordenes.store'=>true,'ordenes.show'=>true,'ordenes.edit'=>true,'ordenes.update'=>true,'ordenes.destroy'=>true,'ordenes.aprobados'=>true,'ordenes.recibidos'=>true,'sac' => 1),
		]);
