...
<html lang="en">
  <head>
    ...
    <link href="{{ asset('assets/sidebar/css/style.css') }}" rel="stylesheet" />
  ...
  <body>
        ...
        <div class="wrapper d-flex align-items-stretch">
            <nav id="sidebar" class="active">
                <h1><a href="index.html" class="logo"><img src="{{ asset('assets/images/logo_movil.png') }}" alt="" style="width: 100%;"></a></h1>
