                ...
                <div class="col-sm-12 " style="margin-top: 1em;">
                    ...
                    <div class="col-xs-6 col-sm-3 col-lg-2 col-md-3 text-center">
                        <a data-id="dashboard" href="#" class=" btn-medium cajita">
                            <div class="row">
                            <div class="col-sm-12" style="height: 2em;" ><i class="fa fa-home"></i></div>
                    ...
                    <div  class="col-xs-6 col-sm-3 col-lg-2 col-md-3 text-center">
                        <a data-id="pedidos" href="#" class=" btn-medium cajita">
                            <div class="row">
                            <div class="col-sm-12" style="height: 2em;" ><i class="fa fa-usd"></i></div>
                    ...
                    <div  class="col-xs-6 col-sm-3 col-lg-2 col-md-3 text-center"> 
                        <a data-id="reportes" href="#" class=" btn-medium cajita">
                            <div class="row">
                            <div class="col-sm-12" style="height: 2em;" ><i class="fa fa-area-chart"></i></div>
                    ...
                    <div class="col-xs-6 col-sm-3 col-lg-2 col-md-3 text-center"> 
                        <a  data-id="categorias"  href="#" class=" btn-medium cajita">
                            <div class="row">
                            <div class="col-sm-12" style="height: 2em;" ><i class="fa fa-tag"></i></div>
                     ...
                     <div  class="col-xs-6 col-sm-3 col-lg-2 col-md-3 text-center"> 
                        <a data-id="productos" href="#" class=" btn-medium cajita">
                            <div class="row">
                            <div class="col-sm-12" style="height: 2em;" ><i class="fa fa-table"></i></div>
                    ...
                    <div  class="col-xs-6 col-sm-3 col-lg-2 col-md-3 text-center"> 
                     ...
                     <div  class="col-xs-6 col-sm-3 col-lg-2 col-md-3 text-center"> 
                        <a data-id="opciones" href="#" class=" btn-medium cajita">
                            <div class="row">
                            <div class="col-sm-12" style="height: 2em;" ><i class="fa fa-cog"></i></div>
                    ...
                    <div  class="col-xs-6 col-sm-3 col-lg-2 col-md-3 text-center"> 
                        <a data-id="salir" href="#" class=" btn-medium cajita">
                            <div class="row">
                            <div class="col-sm-12" style="height: 2em;" ><i class="fa fa-sign-out"></i></div>
