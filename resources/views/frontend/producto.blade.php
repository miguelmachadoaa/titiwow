                    ...
                    <div class="productos">
                        ...
                        @if($producto->tipo_producto=='1' || $producto->tipo_producto=='4')  
                            ...
                            @if(isset($inventario[$producto->id]))
                                ...
                                @if($inventario[$producto->id]>0)
                                    ...
                                    <a data-slug="{{ $producto->slug }}" data-price="{{ intval($producto->precio_oferta) }}" data-sku="{{ $producto->referencia_producto_sap }}" data-ean="{{ $producto->referencia_producto }}" data-id="{{ $producto->id }}" data-name="{{ $producto->nombre_producto }}" data-imagen="{{ secure_url('/').'/uploads/productos/'.$producto->imagen_producto }}" class="btn btn-md btn-cart addtocart" href="{{secure_url('cart/addtocart', [$producto->slug])}}" alt="Agregar al Carrito"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                        ...
                        <!-- Proceso para productos de tipo combo -->
                            ...
                            @if(isset($combos[$producto->id]) && isset($inventario[$producto->id]))
                                ...
                                @if($inventario[$producto->id]>0 && !is_numeric($combos[$producto->id]) )
                                    ...
                                    <a class="btn btn-md btn-vermas" href="{{ route('producto', [$producto->slug]) }}">Ver <i class="fa fa-plus" aria-hidden="true"></i></a>
                                    <a data-slug="{{ $producto->slug }}" data-sku="{{ $producto->referencia_producto_sap }}" data-ean="{{ $producto->referencia_producto }}" data-price="{{ intval($producto->precio_oferta) }}" data-id="{{ $producto->id }}" data-name="{{ $producto->nombre_producto }}" data-imagen="{{ secure_url('/').'/uploads/productos/'.$producto->imagen_producto }}" class="btn btn-md btn-cart addtocart" href="{{secure_url('cart/addtocart', [$producto->slug])}}" alt="Agregar al Carrito"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
