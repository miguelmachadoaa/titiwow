...
@section('header_styles')
 ...
 <link rel="canonical" href="{{url('misdirecciones')}}" />
    ...
    <div class="row">
        ...
        <div class="row" id="addAddressForm" style="margin-top: 1em; @if(count($errors)) @else display: none; @endif ">
            ...
            <div class="col-sm-12" style="border: 1px solid rgba(0,0,0,0.1);  padding: 2em; margin: 0em -2em;">
                ...
                <form method="POST" action="{{url('clientes/storedir')}}" id="addDireccionForm" name="addDireccionForm" class="form-horizontal     ">
                    ...
                    <div style="  margin-bottom: 1em;" class=" col-sm-10 col-sm-offset-1 {{ $errors->first('calle_address', 'has-error') }}">
                        ...
                        <div class="col-sm-6 pl-0" style="padding-left: 0;">
                                ...
                                <div class="row">
                                    ...
                                    @else
                                        ...
                                        @else
                                            ...
                                            <a href="{{ url('/clientes/setdir/'.$dir->id) }}" class="btn btn-xs btn-primary">Favorita</a>

                                        @endif

                                        <a href="{{ url('/clientes/deldir/'.$dir->id) }}" class="btn btn-xs btn-danger">Eliminar</a>
