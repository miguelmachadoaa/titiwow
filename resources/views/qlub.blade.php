        ...
        <div class="row" style="padding: 0; margin:0;">
            <div class="col-sm-offset-3 col-sm-6 col-xs-12" style="padding-top: 1em; ">
                <div class="video-responsive_qlub" style="width: 100%;">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/52m3DA8AM9s" title="el QLUB del queso Alpina" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>  
            </div>
        </div>
