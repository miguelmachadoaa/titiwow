                        ...
                        {!! Form::model($configuracion, ['url' => secure_url('admin/configuracion/'. $configuracion->id), 'method' => 'put', 'class' => 'form-horizontal']) !!}
                           ...
                           <!-- <div class="form-group {{ $errors->first('key_mercadopago', 'has-error') }}">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group {{ $errors->first('public_key_360', 'has-error') }}">
                                    <label for="public_key_360" class="col-sm-2 control-label">
                                        Public Key 360 
                                    </label>
                                    <div class="col-sm-5">
                                        <input type="text" id="public_key_360" name="public_key_360" class="form-control" placeholder="Public Key 360 "
                                            value="{!! old('public_key_360', $configuracion->public_key_360) !!}">
                                    </div>
                                    <div class="col-sm-4">
                                        {!! $errors->first('public_key_360', '<span class="help-block">:message</span> ') !!}
                                    </div>
                                </div>


                                <div class="form-group {{ $errors->first('private_key_360', 'has-error') }}">
                                    <label for="private_key_360" class="col-sm-2 control-label">
                                        Private key 360 
                                    </label>
                                    <div class="col-sm-5">
                                        <input type="text" id="private_key_360" name="private_key_360" class="form-control" placeholder="Private key 360  "
                                            value="{!! old('private_key_360', $configuracion->private_key_360) !!}">
                                    </div>
                                    <div class="col-sm-4">
                                        {!! $errors->first('private_key_360', '<span class="help-block">:message</span> ') !!}
                                    </div>
                                </div>
