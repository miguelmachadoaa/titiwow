                                    ...
                                    <tr>
                                        <td colspan="4">
                                            <div class="compose row">
                                                ...
                                                <input type="email" class="col-xs-9" id="email" placeholder="Email Id" tabindex="1" required>
                                                <div class="clear"></div>
                                                <label class="col-xs-2 hidden-xs" for="sub">Subject:</label>
                                                <input type="text" class="col-xs-9" id="sub" tabindex="1" value="Fwd: New server for datacenter needed ">
                                                <div class="clear"></div>
                                                <div id="ccb">
...
@section('footer_scripts')
    ...
    <script  src="{{ secure_asset('assets/vendors/summernote/summernote.min.js') }}"  type="text/javascript"></script>
