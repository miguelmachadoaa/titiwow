        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                       ...
                       <form enctype="multipart/form-data" class="form-horizontal" role="form" method="POST" action="{{ url('admin/departamento/') }}">
                            <!-- CSRF Token -->
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <a class="btn btn-danger" href="{{url('admin/departamentos')}}">Volver</a>
                        </div>
                    </div>
