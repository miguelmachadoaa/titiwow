        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="{{ secure_url('admin/urgencias/create') }}">
                        <!-- CSRF Token -->
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-4">
                                ...
                                <a class="btn btn-danger" href="{{ secure_url('admin/urgencias') }}">
                                    Cancelar
                                </a>
