        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <a href="{{ url('admin/impuestos/create') }}" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-plus"></span> Crear Impuestos</a>
                    </div>
                </div>
                <br />
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            <a href="{{ url('admin/impuestos/'.$row->id.'/edit') }}">
                                            ...
                                            <a href="{{ url('admin/impuestos/'.$row->id.'/confirm-delete') }}" data-toggle="modal" data-target="#delete_confirm">
