                ...
                <div class="panel-body">
                        ...
                        {!! Form::model($impuestos, ['url' => secure_url('admin/impuestos/'. $impuestos->id), 'method' => 'put', 'class' => 'form-horizontal']) !!}
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="nombre_impuesto" name="nombre_impuesto" class="form-control" placeholder="Nombre de Impuestos"
                                       value="{!! old('nombre_impuesto', $impuestos->nombre_impuesto) !!}">
                            </div>
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-5">
                              ...
                              <div class="col-sm-5">
                                <input type="number" step="0.01" id="valor_impuesto" name="valor_impuesto" class="form-control" placeholder="Valor del impuesto"
                                       value="{!! old('valor_impuesto', $impuestos->valor_impuesto) !!}">
                            </div>
                            </div>
                            <div class="col-sm-4">
                       ...
                       <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-4">
                                <a class="btn btn-danger" href="{{ route('admin.impuestos.index') }}">
                                    Cancelar
                                </a>
