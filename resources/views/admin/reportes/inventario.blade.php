...
{{-- Web site Title --}}
@section('title')
Reporte de Inventario Almacen bogota 
@parent
@stop
...
<section class="content-header">
    <h1>Reporte de Inventario Almacen bogota  </h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li class="active">Inventario Almacen bogota</li>
    </ol>
</section>
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="get" action="{{ secure_url('/reportes/exportinventario') }}">
