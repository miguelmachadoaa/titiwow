...
<section class="content-header">
    <h1>Reporte de  Clientes con Compras </h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li class="active">Detalle de Clientes con Compras</li>
    </ol>
</section>
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="post" action="{{ secure_url('admin/reportes/exportdetalleclientes') }}">
