...
<section class="content-header">
    <h1>Reporte de Ventas con Descuento </h1>
    <ol class="breadcrumb">
        <li>
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="post" action="{{ secure_url('admin/reportes/exportventasdescuento') }}">
