...
<section class="content-header">
    <h1>Listado de Ordenes por Cliente </h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li class="active">Listado de Ordenes por cliente</li>
    </ol>
</section>
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    Listado de Ordenes por cliente
                    </h4>
                </div>
                <br />
                <div class="panel-body">

                    <form class="form-horizontal" role="form" method="post" action="{{ secure_url('admin/reportes/exportformato') }}">
