...
<section class="content-header">
    <h1>Reporte de Masterfile Embajadores </h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li class="active">Masterfiles Embajadores</li>
    </ol>
</section>
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    <h4 class="panel-title pull-left"> <i class="livicon" data-name="users" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
                       Reporte Masterfiles  Embajadores
                    </h4>
                </div>
                <br />
                <div class="panel-body">

                    <form class="form-horizontal" role="form" method="post" action="{{ secure_url('admin/reportes/exportmasterfileembajadores') }}">
