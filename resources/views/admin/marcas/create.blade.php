        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="{{ url('admin/marcas/create') }}">
                        <!-- CSRF Token -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                ...
                                <div class="fileinput-new thumbnail" style="max-width: 200px; max-height: 200px;">
                                    ...
                                    <img src="{{ asset('/uploads/categorias/default.png') }}" alt="..."class="img-responsive"/>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-4">
                                ...
                                <a class="btn btn-danger" href="{{ url('admin/marcas') }}">
                                    Cancelar
                                </a>
