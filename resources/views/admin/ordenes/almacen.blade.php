...
<section class="content-header">
    <h1>Ordenes por Almacen @if(isset($almacen->id)) {{$almacen->nombre_almacen}} @endif</h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li><a href="#"> Ordenes por Almacen</a></li>
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    <h4 class="panel-title pull-left"> <i class="livicon" data-name="users" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
                       Ordenes Almancen @if(isset($almacen->id)) {{$almacen->nombre_almacen}} @endif
                    </h4>
 ...
 $('#tbOrdenes').on('click','.aprobar', function(){
    ...
    $(document).ready(function() {
        ...
        var table =$('#tbOrdenes').DataTable( {
            "processing": true,
            "ajax": {
                "url": base+'/admin/ordenes/dataalmacen'
            }
        } );
