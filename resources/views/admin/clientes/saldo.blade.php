...
{{-- Web site Title --}}
@section('title')
Saldo de @lang('clientes/title.clientes')
@parent
@stop
...
<section class="content-header">
    <h1> Saldo de @lang('clientes/title.clientes')</h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li><a href="#"> Saldo de @lang('clientes/title.clientes') </a></li>
...
<script>
     ...
     $(document).ready(function() {
	    ...
	    var table =$('table').DataTable( {
	        "processing": true,
	        "ajax": {
	            "url": base+'/admin/clientes/datasaldo'
	        }
	    });
