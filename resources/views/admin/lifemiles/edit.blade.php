        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <div class="panel-body"> 
                    ...
                    @endif
                    {!! Form::model($lifemile, ['url' => url('admin/lifemiles/'. $lifemile->id), 'method' => 'put', 'class' => 'form-horizontal']) !!}
                        ...
                        <div class="form-group {{ $errors->
                            ...
                            <div class="col-sm-5">
                                <input type="number" step="1" min="0" id="cantidad_cupones" name="cantidad_cupones" class="form-control" placeholder=" Minimo Compra"
                                       value="{!! old('cantidad_cupones', $lifemile->cantidad_cupones) !!}">
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-4">
                                ...
                                <a class="btn btn-danger" href="{{ url('admin/lifemiles') }}">
                                    Cancelar
                                </a>
