        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form enctype="multipart/form-data" class="form-horizontal" role="form" method="post" action="{{ url('admin/empresas/create') }}">
                        <!-- CSRF Token -->
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-4">
                                ...
                                <a class="btn btn-danger" href="{{ url('admin/empresas') }}">
                                    Cancelar
                                </a>
