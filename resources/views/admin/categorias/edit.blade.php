        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                        ...
                        {!! Form::model($categoria, ['url' => url('admin/categorias/'. $categoria->id), 'files'=> true, 'method' => 'put', 'class' => 'form-horizontal']) !!}
                            <!-- CSRF Token -->
                            {{ csrf_field() }}
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                ...
                                <div class="fileinput-new thumbnail" style="max-width: 200px; max-height: 200px;">
                                    ...
                                    @else
                                        ...
                                        <img src="{{ asset('uploads/categorias/default.jpg') }}" alt="..."
