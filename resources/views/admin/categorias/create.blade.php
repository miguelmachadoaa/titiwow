        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form class="form-horizontal bf" enctype="multipart/form-data" role="form" method="post" action="{{ url('admin/categorias/create') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                ...
                                <div class="fileinput-new thumbnail" style="max-width: 200px; max-height: 200px;">
                                    ...
                                    <img src="{{ asset('/uploads/categorias/default.jpg') }}" alt="..."class="img-responsive"/>
