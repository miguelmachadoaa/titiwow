        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <a href="{{ secure_url('admin/sliders/create') }}" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-plus"></span> Crear Sliders</a>
                    </div>
                </div>
                <br />
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            <a href="{{ secure_url('admin/sliders/'.$row->id.'/edit') }}">
