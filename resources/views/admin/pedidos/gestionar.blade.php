        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                        ...
                        {!! Form::model($almacen, ['url' => url('admin/almacenes/'. $almacen->id.'/postgestionar'), 'method' => 'POST', 'class' => 'form-horizontal', 'files'=> true]) !!}
                            <!-- CSRF Token -->
                            {{ csrf_field() }}
                        ...
                        <tr>
                            ...
                            <td>
                                <img style="width: 60px;" src="{{url('uploads/productos/'.$p->imagen_producto)}}" alt="img">
                            </td>
