@if(count($formaspago))
            ...
            <div class="col-sm-12 ">
                ...
                <div class="panel-group" id="accordion-detalles" role="tablist" aria-multiselectable="true">
                                        ...
                                        <li style="list-style-type: none;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="hidden-xs col-sm-2 ">
                                                   ...
                                                   <a href="{{ route('producto', [$car->slug]) }}"> <img width="50em" src="{{ url('/').'/uploads/productos/60/'.$car->imagen_producto }}"  alt="{{ $car->nombre_producto }}" title="{{ $car->nombre_producto }}"></a>
                                                ...
                                                <div class="col-xs-3 col-sm-2 ">{{  number_format($car->precio_unitario*$car->cantidad,0,",",".")  }} COP</div>
                    ...
                    @include('admin.pedidos.detallescompra')
