...
{{-- Web site Title --}}
@section('title')
Actualizacion de Productos Masivos
@parent
@stop
...
<section class="content-header">
    <h1>Actualizacion de Productos Masivos</h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li class="active">Actualizacion de Productos Masivos</li>
    </ol>
</section>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <form class="" enctype="multipart/form-data" role="form" method="post" action="{{ secure_url('admin/productos/postproductosmasivos') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group {{ $errors->
                            ...
                            <div class="row" style="margin-top: 1em;">
                                ...
                                <div class="col-sm-12">
                                    <a class="btn btn-link" target="_blank" href="{{secure_url('admin/productos/productosmasivosexport')}}">Descargar Archivo de productos</a>
                                </div>
                            </div>
                        </div>
