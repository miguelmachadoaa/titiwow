        ...
        <div class="panel panel-primary ">
            ...
            <div class="panel-body table-responsive">
                ...
                <div style="margin-bottom: 1em; margin-top: 1em;" class="row">
                     ...
                     <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" action="{{ url('admin/productos/'.$categoria->id.'/editarcategoria') }}">
                            <!-- CSRF Token -->
                            {{ csrf_field() }}
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a  href="{{url('productos/'.$c->id.'/gestionarancheta')}}" class="btn btn-primary">Gestionar</a>

                                <a  href="{{url('productos/'.$c->id.'/eliminarcategoria')}}" class="btn btn-danger"><i class=" fa fa-trash"></i></a>

                                <a  href="{{url('productos/'.$c->id.'/editarcategoria')}}" class="btn btn-info"><i class=" fa fa-pencil"></i></a>
