...
@section('content')
    ...
    <section class="content paddingleft_right15">
      ...
      <div class="panel panel-primary">
        ...
        {!! Form::model($producto, ['url' => url('admin/productos/'. $producto->id.''), 'method' => 'put', 'id'=>'productosForm', 'files'=> true]) !!}
                            ...
                            <div class="panel panel-success  @if($producto->tipo_producto==3) @else {{ 'hidden' }}  @endif " id="panelAnchetaProductos">
                                ...
                                <div id="addAncheta" class="panel-collapse collapse in">
                                    <div class="panel-body">
                                            ...
                                            <a class="btn btn-primary" href="{{url('admin/productos/'.$producto->id.'/ancheta')}}">Configurar Ancheta</a>
                                                ...
                                                <div class="col-sm-9 col-xs-12">
                                                    ...
                                                    <select id="unidad" name="unidad" class="form-control ">
                                                        ...
                                                        <option value="{{ $u->nombre_unidad }}"
                                                            ...
                                                            @if($producto->unidad == $u->nombre_unidad) selected="selected" @endif >
                                            ...
                                            <div class="col-sm-9">   
                                             <select id="pesable" name="pesable" class="form-control ">
                                                <option value="">Seleccione</option>
                                                 ...
                                                 <option value="{{ 0}}"
                                                       @if($producto->pesable == 0) selected="selected" @endif    >No Pesable</option>
                                                   
                                                    <option value="{{ 1 }}"
                                                        @if($producto->pesable == 1) selected="selected" @endif     >Pesable</option>
                                                ...
                                                <div class="form-group col-sm-2" style="margin: 0 0 15px 0;">
                                                    ...
                                                    <div class="" >
                                                        ...
                                                        <select style="width: 100%; height: 2.5em;" id="{{ 'roldescuento_'.$pg->id_role.'_'.$pg->city_id }}" name="{{ 'roldescuento_'.$pg->id_role.'_'.$pg->city_id }}" data-rc="{{ $pg->id_role.'_'.$pg->city_id }}" class="form-control  select2">
                                                            ...
                                                            <option value="0" @if($pg->mostrar_descuento == '0') selected="selected" @endif  >No Mostrar</option>
