...
<head>
    ...
    <!-- page level css -->
    <link href="{{ secure_asset('assets/css/pages/login2.css') }}" rel="stylesheet" />
    <link href="{{ secure_asset('assets/vendors/iCheck/css/minimal/blue.css') }}" rel="stylesheet"/>
...
<script src="{{ secure_asset('assets/js/TweenLite.min.js') }}"></script>
<script src="{{ secure_asset('assets/vendors/iCheck/js/icheck.js') }}" type="text/javascript"></script>
<script src="{{ secure_asset('assets/vendors/bootstrapvalidator/js/bootstrapValidator.min.js') }}" type="text/javascript"></script>
<script src="{{ secure_asset('assets/js/pages/register2.js') }}" type="text/javascript"></script>
