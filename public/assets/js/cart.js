jQuery(document).ready(function($){
	...
	function addProduct2(trigger) {
		...
		var productAdded = $('<li class="product"><div class="product-image"><a href="#0"><img src="'+trigger.data('imagen')+'" alt="placeholder"></a></div><div class="product-details"><h3><a href="#0">'+trigger.data('name')+'</a></h3><span class="price">'+trigger.data('price')+'</span><div class="actions"><a href="#0" data-id="'+trigger.data('id')+'" data-slug="'+trigger.data('slug')+'" class="delete-item">Borrar</a><div class="quantity"><label for="cd-product-'+ productId +'">Cantidad: </label><span class="select"><select class="cartselect" data-slug="'+trigger.data('slug')+'" id="cd-product-'+ productId +'" name="quantity"><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></span></div></div></div></li>');
		cartList.prepend(productAdded);
	}
