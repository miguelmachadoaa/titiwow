...
Route::get('reportes/usocupones', 'Admin\AlpReportesController@usocupones')->name('reportes.usocupones');
...
*/
    ...
    Route::get('tomapedidos/cancelarpedido', 'Admin\AlpPedidosController@cancelarpedido');
